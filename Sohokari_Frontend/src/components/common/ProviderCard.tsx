      ...
      <View style={styles.header}>
        ...
        <View style={{ flex: 1, marginLeft: 12 }}>
          ...
          <View style={styles.catRow}>
            ...
            <View style={[styles.availBadge, { backgroundColor: provider.isAvailable ? '#E1F5EE' : '#F3F4F6' }]}>
              <View style={[styles.dot, { backgroundColor: provider.isAvailable ? Colors.success : Colors.textMuted }]} />
              <Text style={[styles.availText, { color: provider.isAvailable ? Colors.success : Colors.textMuted }]}>
...
const styles = StyleSheet.create({
  card:        { backgroundColor: Colors.surface, borderRadius: 14, padding: 14, marginBottom: 12, shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.07, shadowRadius: 8, elevation: 3 },
  ...
  name:        { fontSize: 15, fontWeight: '600', color: Colors.text, marginBottom: 6 },
  catRow:      { flexDirection: 'row', gap: 6, flexWrap: 'wrap' },
  catBadge:    { backgroundColor: '#EBF0F8', borderRadius: 6, paddingHorizontal: 8, paddingVertical: 2 },
  catText:     { fontSize: 11, color: Colors.primaryLight, fontWeight: '600' },
  availBadge:  { flexDirection: 'row', alignItems: 'center', borderRadius: 6, paddingHorizontal: 8, paddingVertical: 2, gap: 4 },
  ...
  compact:     { flexDirection: 'row', alignItems: 'center', backgroundColor: Colors.surface, borderRadius: 12, padding: 12, marginBottom: 8, gap: 10, elevation: 1 },
  compactAvatar: { width: 38, height: 38, borderRadius: 19, backgroundColor: Colors.primaryLight, alignItems: 'center', justifyContent: 'center' },
