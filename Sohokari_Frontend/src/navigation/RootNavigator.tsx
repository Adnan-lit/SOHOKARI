    ...
    <NavigationContainer>
      ...
      >
        {!isLoggedIn ? (
          ...
          <Stack.Screen name="ProviderApp" component={ProviderNavigator} options={{ headerShown: false }} />
        ) : (
        ...
        <Stack.Screen name="ChatRoom"        component={ChatRoomScreen}        options={({ route }) => ({ title: route.params.participantName })} />
        <Stack.Screen name="ReviewForm"      component={ReviewFormScreen}      options={{ title: 'Leave a Review'   }} />
        <Stack.Screen name="ReviewList"      component={ReviewListScreen}      options={{ title: 'Reviews'          }} />
        <Stack.Screen name="Search"          component={SearchScreen}          options={{ title: 'Search'           }} />
        <Stack.Screen name="NearbyMap"       component={NearbyMapScreen}       options={{ title: 'Nearby Providers' }} />
